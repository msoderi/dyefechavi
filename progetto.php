...
{
?>
<div class="right_b"><a class="primo_piano" href="notizia.php?id=<?=$primopiano["newsid"]?>" title="<?=str_replace("\"","&quot;",$primopiano["newstitle"])?>"><?=trim($primopiano["newstitle"])?trim($primopiano["newstitle"]):"Notizia senza titolo"?></a></div>
<?php
}
?>
                <br />
...
<p style="font-weight:bold;">Synd si propone come punto di accesso privilegiato verso il patrimonio di informazioni che l'intera Pubblica Amministrazione italiana, dalla Presidenza della Repubblica al pi&ugrave; piccolo dei comuni, pubblica quotidianamente sul Web.</p>
