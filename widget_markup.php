...
$larghezza = 280;
if(isset($_POST["larghezza"]) && is_numeric($_POST["larghezza"]) && floor($_POST["larghezza"]) > 280) $larghezza = floor($_POST["larghezza"]);

$altezza = 180;
if(isset($_POST["altezza"]) && is_numeric($_POST["altezza"]) && floor($_POST["altezza"]) > 180) $altezza = floor($_POST["altezza"]);

$tipologia = "Ultime Notizie";
if(isset($_POST["tipologia"]) && $_POST["tipologia"] == "primo_piano") $tipologia = "Primo Piano";
if(isset($_POST["tipologia"]) && $_POST["tipologia"] == "custom_query") $tipologia = "Query Personalizzata";

$query_personalizzata = "";
if(isset($_POST["query_personalizzata"])) $query_personalizzata = htmlentities($_POST["query_personalizzata"]);

$widgetparam__width = $larghezza;
$widgetparam__height = $altezza;
$widgetparam__type = "";
if($tipologia == "Ultime Notizie") $widgetparam__type = "list_last";
if($tipologia == "Primo Piano") $widgetparam__type = "primo_piano";
if($tipologia == "Query Personalizzata") $widgetparam__type = "custom_query";
$widgetparam__query = rawurlencode($_POST["query_personalizzata"]);



// Qui bisogna prendere i parametri, validarli, se c'e' un errore dare l'errore, se sono ok metterli in variabili apposite ai soli fini di visualizzazione /riassunto della richiesta.
// Poi a partire da quei parametri bisogna comporre il markup che e' il fine ultimo del tutto.
...
<p style="text-align:right; margin-top:10px;"><a class="tip" title="Tip" href="tip.php?id=<?=$tip["id"]?>">[scopri come]</a></p>
		...
		<div class="tit_bot" <?php if(false !== strpos($_SERVER["HTTP_USER_AGENT"],"MSIE")) echo("style=\"background: url('images/bg_tit_ie.png') left top no-repeat !important; width:570px;\""); ?>>
                  	<h1>Synd Network Widget Markup</h1>
			<div class="text">
<p style="font-family:monospace;">

<span style="font-weight:bold;">Larghezza</span><br />
<?=$larghezza?> pixel<br /><br />

<span style="font-weight:bold;">Altezza</span><br />
<?=$altezza?> pixel<br /><br />

<span style="font-weight:bold;">Tipologia</span><br />
<?=$tipologia?><br /><br />

<span style="font-weight:bold;">Query Personalizzata</span><br />
<?=trim($query_personalizzata) != "" ? $query_personalizzata : "<span style=\"font-style:italic;\">non specificata</span>"?><br /><br />

</p>

<p style="font-family:monospace;">

<span style="font-weight:bold;">MARKUP HTML DA INSERIRE NELLA PAGINA<br />------------------------------------<br /></span>
<?=htmlentities("<div id=\"synd_div\"></div><script type=\"text/javascript\" language=\"javascript\" src=\"http://www.synd.it/synd/widgetcall.php?width=$widgetparam__width&amp;height=$widgetparam__height&amp;type=$widgetparam__type&amp;query=$widgetparam__query\"></script>")?>
