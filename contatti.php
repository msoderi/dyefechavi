...
<p style="text-align:right; margin-top:10px;"><a class="tip" title="Tip" href="tip.php?id=<?=$tip["id"]?>">[scopri come]</a></p>
		...
		<div class="tit_bot" <?php if(false !== strpos($_SERVER["HTTP_USER_AGENT"],"MSIE")) echo("style=\"background: url('images/bg_tit_ie.png') left top no-repeat !important; width:570px;\""); ?>>
			...
			<div class="text">
<p>Nessuno dei campi di questo modulo &egrave; obbligatorio, e nessuna informazione viene in alcun caso inviata in aggiunta rispetto a quelle che tu stesso inserisci. Attento che questo significa anche che se non immetti un indirizzo e-mail per la risposta, non potrai in alcun caso riceverne una.</p>
<form class="modulo_contatto" method="post" action="salva_messaggio.php">
<p>il tuo nome e cognome<br />
<input type="text" name="mittente" /></p>
<p>il tuo indirizzo e-mail<br />
<input type="text" name="email" /></p>
<p>oggetto del messaggio<br />
<input type="text" name="oggetto" /></p>
<p>contenuto del messaggio<br />
<textarea name="contenuto" rows="4" cols="60"></textarea></p>
